...
public class PojoGenerationConfigTest {
	...
	public void testBigDecimalConfig() throws Exception {
		final SpringMvcEndpointGeneratorMojo mojo = (SpringMvcEndpointGeneratorMojo) configureMojo("useBigDecimals",
	...
	public void testLocalDateTimeConfig() throws Exception {
		final SpringMvcEndpointGeneratorMojo mojo = (SpringMvcEndpointGeneratorMojo) configureMojo("dateTimeType",
